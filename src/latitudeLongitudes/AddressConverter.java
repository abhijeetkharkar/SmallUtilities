...
public class AddressConverter
{
	...
	{
		GoogleResponse res = new AddressConverter().convertToLatLong("Vishal Hall, Andheri East, Mumbai ,Maharashtra, India");
		...
		System.out.println("\n");
		GoogleResponse res1 = new AddressConverter().convertFromLatLong("19.118165,72.852259");
